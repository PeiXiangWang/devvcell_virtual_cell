...
| Does the GRN layer establish a regulatory mechanism? | No. pySCENIC/CellOracle were audited but not claimed as native runs; fallback TF-target modules recover candidate developmental programs, but internal/E1 GRN controls are not clean enough for a mechanism claim. | GRN evidence matrix, GRN negative controls | native GRN inference and experimental perturbation absent | GRN audit and candidate regulatory hypotheses only |
